...
export const MEDIA_CARD_CLASS =
  "group/card w-full min-w-0 gap-0 overflow-hidden rounded-[8px] border border-outline-variant/60 bg-surface-container-low p-0 shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06)] transition-transform hover:-translate-y-0.5";
